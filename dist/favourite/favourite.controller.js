...
], FavouriteController.prototype, "findAllStation", null);
__decorate([
    (0, common_1.Get)('bus'),
    __param(0, (0, decorator_1.GetUser)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], FavouriteController.prototype, "findAllBus", null);
__decorate([
    (0, common_1.Post)('station/:id'),
    __param(0, (0, decorator_1.GetUser)('id')),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], FavouriteController.prototype, "updateStation", null);
__decorate([
    (0, common_1.Post)('bus/:id'),
    __param(0, (0, decorator_1.GetUser)('id')),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], FavouriteController.prototype, "updateBus", null);
